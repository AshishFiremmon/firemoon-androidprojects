...
import com.example.test_11.doctorappointmentapp.ReviewActivity;
...
public class RecordFrgment extends Fragment implements IResponse{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        list.clear();
		if(mView == null){
			mView = inflater.inflate(R.layout.record_screen, container, false);
...
//			((ViewGroup) mView.getParent()).removeView(mView);
	...
	public void getBookedDoctorList() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				new Web().requestPostStringData(AppUrl.bookeddoctorUrl, data, RecordFrgment.this, 200);
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(final  int position, View convertView, ViewGroup parent) {
			...
			row1.findViewById(R.id.reviewTxt).setOnClickListener(new View.OnClickListener() {
				@Override
