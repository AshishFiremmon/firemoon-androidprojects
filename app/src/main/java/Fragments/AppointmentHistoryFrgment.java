...
public class AppointmentHistoryFrgment extends Fragment implements IResponse{
	...
	public AppointmentHistoryFrgment(){
...
list.clear();
		if(mView == null){
			mView = inflater.inflate(R.layout.apphistory_screen, container, false);
...
*/
	...
	public void getBookedDoctorList() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				new Web().requestPostStringData(AppUrl.bookeddoctorUrl, data, AppointmentHistoryFrgment.this, 200);
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(final  int position, View convertView, ViewGroup parent) {
			...
			View row1 = inflater.inflate(R.layout.history_list, parent, false);
