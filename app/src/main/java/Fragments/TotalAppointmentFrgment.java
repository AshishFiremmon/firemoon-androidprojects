...
public class TotalAppointmentFrgment extends Fragment implements IResponse{
	...
	public TotalAppointmentFrgment(){
...
list.clear();
		if(mView == null){
			mView = inflater.inflate(R.layout.totalapp_screen, container, false);
...
*/
	...
	public void getBookedDoctorList() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				new Web().requestPostStringData(AppUrl.bookeddoctorUrl, data, TotalAppointmentFrgment.this, 200);
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(final  int position, View convertView, ViewGroup parent) {
			...
			View row1 = inflater.inflate(R.layout.totalapp_list, parent, false);
